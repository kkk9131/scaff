...
import { buildFlatRoofWireFromFloor, buildFlatRoofWireStyledFromFloor, buildGableRoofWireStyledFromFloor, mmToM, bboxOfSegments } from '@/core/wireframe-3d'
